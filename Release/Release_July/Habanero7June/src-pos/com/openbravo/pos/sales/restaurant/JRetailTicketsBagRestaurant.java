...
public class JRetailTicketsBagRestaurant extends javax.swing.JPanel {
    ...
    //Method is used for enabling the pos buttons based on login user
    ...
    //Method is for setting the table name in billing screen
    ...
    // Method called when exiting the billing screen

    public static void setNewTicket() {
        m_restaurant.newTicket();
    }
    // Method called when spliting the bill
    ...
    // Method called when holding the bill
    ...
    //Method called when cancelling the bill
