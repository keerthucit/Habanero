...
public class DataLogicSales extends BeanFactoryDataSingle {
    ...
    public final ProductInfoExt getProductInfo(String id) throws BasicException {
        ...
        System.out.println("products selection 1");
        return (ProductInfoExt) new PreparedSentence(s
            , "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, M.PRICEBUY,M.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, M.MRP,U.NAME,P.PRODUCTTYPE,P.PRODUCTIONAREATYPE,P.SERVICECHARGE,P.SERVICETAX,C.PARENTID,P.PREPARATIONTIME,P.SWACHBHARATTAX,P.ISCOMBOPRODUCT " +
...
public int getItemCount(String itemCode) throws BasicException {
    ...
    public List<ProductInfoExt> getProductComments(String id) throws BasicException {
        ...
        return new PreparedSentence(s
            , "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, P.PRICEBUY, P.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, P.MRP,C.PARENTID,P.PREPARATIONTIME,P.SWACHBHARATTAX,P.ISCOMBOPRODUCT " +
...
//       SimpleDateFormat time = new SimpleDateFormat("hh:mm:ss");
     ...
     public List<CampaignIdInfo> getPdtCampaignId() throws BasicException {
        return (List<CampaignIdInfo>) new PreparedSentence(s
                , "SELECT DISTINCT CAMPAIGNID FROM TEMPTICKETLINES WHERE ISCROSSPROMOPRODUCT='N' AND PROMOTYPE='BuyGet' "
                , null
                , new SerializerReadClass(CampaignIdInfo.class)).list();
       }
...
//    }
   ...
   public List<PromoRuleIdInfo> getPromoRuleId(String campaignId) throws BasicException {
        return (List<PromoRuleIdInfo>) new PreparedSentence(s
                , "SELECT ID FROM PROMOTIONRULE WHERE PROMOTIONCAMPAIGNID IN ("+campaignId+") "
                , null
   ...
   public List<BuyGetInfo> getbuyGetTotalQty(String campaignId) throws BasicException {
        ...
        return (List<BuyGetInfo>) new PreparedSentence(s
                , " SELECT SUM(QUANTITY), CAMPAIGNID FROM TEMPTICKETLINES WHERE CAMPAIGNID IN ("+campaignId+") AND PROMOTYPE='BuyGet' AND ISCROSSPROMOPRODUCT ='N' GROUP BY CAMPAIGNID  "
                , null
 ...
 public List<BuyGetPriceInfo> getbuyGetLeastPrice(String campaignId, int qty) throws BasicException {
        ...
        return (List<BuyGetPriceInfo>) new PreparedSentence(s
                , " SELECT T.PRODUCTID, T.PRICE, P.CATEGORY, P.TAXCAT, T.QUANTITY, P.ATTRIBUTESET_ID, T.CAMPAIGNID, T.TAXRATE FROM TEMPTICKETLINES T, PRODUCTS P WHERE P.ID=T.PRODUCTID AND T.CAMPAIGNID ='"+campaignId+"' ORDER BY PRICE ASC  LIMIT "+qty+"  "
                , null
 ...
 public List<ProductInfoExt> getPopularProduct(String popular) throws BasicException  {
    ...
    public List<PromoRuleIdInfo> getPromoLeastRuleId(String campaignId) throws BasicException {
        return (List<PromoRuleIdInfo>) new PreparedSentence(s
                , "SELECT PR.ID FROM PROMOTIONRULE PR, PROMOTIONTYPE PT WHERE PT.ID=PR.PROMOTIONTYPEID AND PR.PROMOTIONCAMPAIGNID IN ("+campaignId+") AND PR.ISCROSSPROMOPRODUCT='N' AND PT.NAME = 'BuyGet'"
                , null
                , new SerializerReadClass(PromoRuleIdInfo.class)).list();
...
//    }
  ...
  //2 level
   public final List<CategoryInfo> getMenuRootCategories(String menuId) throws BasicException {
        return new PreparedSentence(s
            , "SELECT CATEGORIES.ID, CATEGORIES.NAME, CATEGORIES.IMAGE FROM CATEGORIES WHERE ID IN ( SELECT coalesce(c.PARENTID,c.id) FROM menupricelist m LEFT JOIN CATEGORIES c  ON  m.productcat=c.id  AND MENUID='"+menuId+"' " +
              "GROUP BY c.ID ORDER BY c.NAME)"
            , null
            , CategoryInfo.getSerializerRead()).list();
    }
  ...
  public final List<CategoryInfo> getMenuSubcategories(String category,String menuId) throws BasicException  {
        return new PreparedSentence(s
            , "SELECT CATEGORIES.ID, CATEGORIES.NAME, CATEGORIES.IMAGE FROM MENUPRICELIST LEFT JOIN CATEGORIES ON MENUPRICELIST.PRODUCTCAT=CATEGORIES.ID WHERE PARENTID = ? AND MENUID='"+menuId+"' GROUP BY CATEGORIES.ID ORDER BY CATEGORIES.NAME "
            , SerializerWriteString.INSTANCE
            , CategoryInfo.getSerializerRead()).list(category);
    }
      ...
      public List<ProductInfoExt> getMenuProductComments(String id,String menuId) throws BasicException {
        ...
        return new PreparedSentence(s
            , "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, MN.PRICEBUY, MN.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, MN.MRP,U.NAME,P.PRODUCTTYPE,P.PRODUCTIONAREATYPE,P.SERVICECHARGE,P.SERVICETAX,C.PARENTID,P.PREPARATIONTIME,P.SWACHBHARATTAX,P.ISCOMBOPRODUCT " +
        ...
        public final List<ProductInfoExt> getMenuProductDetails(String menuId) throws BasicException {
         System.out.println("products selection 23");
            return new PreparedSentence(s
            , "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, M.PRICEBUY, M.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, M.MRP,U.NAME,P.PRODUCTTYPE,P.PRODUCTIONAREATYPE,P.SERVICECHARGE,P.SERVICETAX,C.PARENTID,P.PREPARATIONTIME,P.SWACHBHARATTAX,P.ISCOMBOPRODUCT  " +
              "FROM PRODUCTS P,UOM U,MENUPRICELIST M,CATEGORIES C  WHERE U.ID=P.UOM AND M.PRODUCTID=P.ID AND P.CATEGORY=C.ID AND P.ISACTIVE='Y' AND P.ISSALESITEM='Y' AND M.MENUID='"+menuId+"' ORDER BY P.NAME"
            , null
            , ProductInfoExt.getSerializerRead()).list();
    }
   ...
   public String getCurrentCloseCash(String date, String host) throws BasicException {
      ...
      public List<ProductInfoExt> getMenuMandatoryAddonProducts(String product,String menuId) throws BasicException  {
        ...
        return new PreparedSentence(s
            ...
            , SerializerWriteString.INSTANCE
            , ProductInfoExt.getSerializerRead()).list(product);
    }
